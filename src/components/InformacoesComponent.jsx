...
const [visivel, setVisivel] = useState(false);
  ...
  return (
        ...
        //                         <div onMouseOver={() => setVisivel(true)} className='image-background w-100 m-lg-5 w-lg-75 mt-5 d-flex flex-column-reverse rounded-3 z-2'>
        ...
        //                                 <h3 className='fs-4 pt-2 ps-1 mb-3'>{subtitle}</h3>
        ...
        //                      >
        //                     <SwiperSlide>
        //                         <div className='col-12 d-flex align-items-center justify-content-end pb-5 flex-column-reverse flex-lg-row'>
        ...
        //                                 <div className='title-badge'></div>
        //                             </div> 
        //                             <div className='col-12 col-lg-8 d-flex justify-content-center align-items-center pb-5 z-2'>
        //                                 <div onMouseOver={() => setVisivel(true)} className='image-background w-100 m-lg-5 w-lg-75 mt-5 mt-5 d-flex flex-column-reverse rounded-3 z-2'>
        ...
        //                                     </div>    
        //                                     <div onMouseLeave={() => setVisivel(false)} className={visivel ? 'hover-content p-3 rounded-3': 'hover-content p-3 invisivel '}>
        //                                         <h3 className='fs-4 pt-2 mb-3'>{subtitle}</h3>
        //                                         <p className='ps-3 fs-6 pt-1'>{text}</p>
        //                                     </div>
        //                                 </div>         
        //                             </div>   
