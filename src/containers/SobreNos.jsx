            ...
            <div className='container p-0 bg-white d-flex flex-column align-items-center rounded-4 pb-5 shadow col-11 col-lg-10'>
                <div className='row p-4 background-sobre rounded-top-4 rounded-bottom-1 m-1'>
                    <div className='col-12 d-flex align-items-center justify-content-center mt-5 mb-5 flex-column z-2'>
                        <h1 className='z-1 text-light' data-aos="fade-down">Sobre Nós</h1>
                        <div className='title-servicos-badge z-0' data-aos="fade-left"></div>
                            <p className='text-white-50 mt-3 text-center w-50' data-aos="fade-right" >Valorizamos a segurança, felicidade e satisfação de nossos clientes!</p>
                        </div>
                        <div className='col-12'>
                            <div className='row d-flex justify-content-center' data-aos="fade-left">
                    ...
                    <div className='col-12'>
                        <div className='col-12 pb-1 mt-5'>
                            <div className='row d-flex justify-content-center'>
                                <div className='col-12 mb-5 d-flex flex-column align-items-center'>
                                    <p className='mt-3 fs-5 text-center pb-1 fw-medium' data-aos="fade-down">Avaliações</p>
                                    <div className='title-servicos-badge-final mt-4 w-25' data-aos="fade-down"></div>
                                </div>
                                <div className='col-10 col-lg-3 text-center bg-white p-4 me-0 me-lg-2 mb-2 rounded-4 shadow'
                                data-aos-delay="100" data-aos-easing="linear" data-aos="fade-down">
                                ...
                                data-aos-delay="300" data-aos-easing="linear" data-aos="fade-down" data-aos-offset="200">
                                    <div className='d-flex justify-content-between pe-3'>
                                        <BiSolidQuoteLeft className='quota-icon'/>
                                ...
                                data-aos-delay="600" data-aos-easing="linear" data-aos="fade-down" data-aos-offset="200">
                                    <div className='d-flex justify-content-between pe-3'>
                                        <BiSolidQuoteLeft className='quota-icon'/>
                                        <h5>Luan Neto</h5>
                                    </div>
                        ...
                        <div className='col-12 pb-5'>
                            <div className='row d-flex justify-content-center'>
                                <div className='col-10 col-lg-3 text-center bg-white p-4 me-0 me-lg-2 mb-2 rounded-4 shadow'
                                data-aos-delay="100" data-aos-easing="linear" data-aos="fade-up">
                                    <div className='d-flex justify-content-between pe-3'>
                                        <BiSolidQuoteLeft className='quota-icon'/>
                                ...
                                <div className='col-10 col-lg-3 text-center bg-white p-4 mb-2 me-0 me-lg-2 rounded-4 shadow'
                                data-aos-delay="300" data-aos-easing="linear" data-aos="fade-up">
                                    <div className='d-flex justify-content-between pe-3'>
                                        <BiSolidQuoteLeft className='quota-icon'/>
                                ...
                                <div className='col-10 col-lg-3 text-center bg-white p-4 mb-2 me-0 me-lg-2 rounded-4 shadow'
                                data-aos-delay="600" data-aos-easing="linear" data-aos="fade-up">
                                    <div className='d-flex justify-content-between pe-3'>
                                        <BiSolidQuoteLeft className='quota-icon'/>
                                        <h5>Matheus Lima</h5>
                                    </div>
                ...
                <div className='title-servicos-badge-final z-0' data-aos="fade-up"></div>
            </div>
        </div>
    </section>
  )
